...
import type { Id, Situation } from '../../../metamodel/ufob';
...
class SituationForm extends React.Component<Props, State> {
  ...
  setAttr = (attr: string, situation: any) => {
    let situationOriginal = this.props.situation;
    let val = situation.currentTarget.value;
    this.setState((state, props) => {
      let situationNew = state.situation2;
      situationNew[attr] = val;
      return {
        situation2: situationNew,
        saveDisabled: R.equals(situationOriginal, situationNew)
      };
    });
  }
