...
export function eiId(ei: EntityInst | null): string {
...
export interface GeneralisationInst {
  gi_id: Id;
  gi_g_id: Id;
  gi_sup_ei_id: Id;
  gi_sub_ei_id: Id;
...
export interface UfoaModelInst {
  entitiesInsts: EntityInst[];
  assocsInsts: AssocInst[];
}
